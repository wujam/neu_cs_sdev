...
class TestPlayerGuard(unittest.TestCase):
    ...
    def test_legit_play(self):
        ...
        player_guard1.end_of_game()
        player_guard2.end_of_game()
    ...
    def test_exception_player(self):
        ...
        self.assertRaises(PlayerRaisedException, player_guard1.end_of_game)
    ...
    def test_loop_player(self):
        ...
        self.assertRaises(PlayerTimeout, player_guard1.end_of_game)
    ...
    def test_malformed_player(self):
        ...
        p1id = uuid.uuid4() 
        self.assertRaises(PlayerMalformedData, player_guard1.set_id, p1id)

        self.assertRaises(PlayerMalformedData, player_guard1.get_name)
        self.assertRaises(PlayerMalformedData, player_guard1.start_of_game)
