...
class TestRulesChecker(unittest.TestCase):
    ...
    def test_is_move_valid_no_workers(self):
        self.assertFalse(self.rule_checker.is_move_valid(1, 1, (0, 1), (0, 1)),\
            msg="A move on a board with no workers should be invalid")

    # tests if a move is valid when there are less than 4 workers
    def test_is_move_valid_some_workers(self):
        self.test_board.set_worker(*self.players[0][0], 1, 1)
        self.assertFalse(self.rule_checker.is_move_valid(1, 1, (0, 1), (0, 1)),\
            msg="A move on a board with less than 4 workers should be invalid")

    # tests if one valid move on a board is valid
    def test_is_move_valid_one_move(self): 
        self._place_workers()

        self.assertTrue(self.rule_checker.is_move_valid(2, 2, (-1, -1), (-1, -1)),\
    ...
    def test_is_move_valid_move_out_of_bound(self):
        self._place_workers()

        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (1, 0), (-1, 0)),\
        ...
        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (1, 1), (-1, -1)),\
            msg="Single move of Player 2 Worker 2 from (5, 5) to (6, 6) building "\
            "on (5, 5), should be invalid as the worker move is out of bounds")

        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (0, 1), (0, -1)),\
            msg="Singel move of Player 2 Worker 2 from (5, 5) to (5, 6) building" \
            "on (5, 5), should be invalid as the worker move is out of bounds")

    # tests failure cases of building out of bounds
    def test_is_move_valid_build_out_of_bound(self):
        self._place_workers()

        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (-1, 0), (0, 1)),\
            msg="Single move of Player 2 Worker 2 from (5, 5) to (4, 5) building "\
            "on (4, 6), should be invalid as the building is out of bounds")

        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (0, -1), (1, 0)),\
    ...
    def test_is_move_valid_worker_onto_too_high_building(self):
        self._place_workers()

        self.assertFalse(self.rule_checker.is_move_valid(1, 1, (0, -1), (-1, 0)),\
    ...
    def test_is_move_valid_worker_onto_higher_building(self):
        self._place_workers()

        self.assertTrue(self.rule_checker.is_move_valid(2, 2, (-1, 0), (0, -1)),\
            msg="Single move of Player 2 Worker 2 from (5, 5) to (4, 5) building "\
    ...
    def test_is_move_valid_moving_onto_another_worker(self):
        self._place_workers()
    ...
    def test_is_move_valid_building_onto_another_worker(self):
        self._place_workers()
    ...
    def test_is_move_valid_moving_onto_max_height_building(self):
        self._place_workers()

        self.test_board.set_worker(4, 0, 1, 2)

        self.assertFalse(self.rule_checker.is_move_valid(1, 2, (1, 0), (0, 1)),\
    ...
    # tests failure case of moving onto a building with MAX height
    def test_is_move_valid_building_onto_max_height_building(self):
        self._place_workers()

        self.test_board.set_worker(4, 0, 1, 2)

        self.assertFalse(self.rule_checker.is_move_valid(1, 2, (0, 1), (1, -1)),\
...
#    def test_is_move_valid_building_onto_a_non_neighboring_space(self):
#        self._place_workers()
#
#        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (-2, 0), (-1, 0)),\
...
#    def test_is_move_valid_building_onto_a_non_neighboring_building(self):
#        self._place_workers()
#
#        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (-1, 0), (-2, 0)),\
#            msg="Single move of Player 2 Worker 2 from (5, 5) to (4, 5) building "\
...
#            "square moved to was expected to be invalid, but was valid")
    ...
    def test_is_move_valid_moving_onto_self(self):
        self._place_workers()

        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (0, 0), (-1, 0)),\
    ...
    def test_is_move_valid_building_onto_self(self):
        self._place_workers()

        self.assertFalse(self.rule_checker.is_move_valid(2, 2, (-1, 0), (0, 0)),\
            msg="Single move of Player 2 Worker 2 from (5, 5) to (4, 5) building "\
